...
impl Repository {
    pub fn find_in_range<E>(&self, start: SheetA1CellId, rows: usize) -> Result<Vec<Entity<E>>>
    where
        E: EntityEssentials,
    {
        let range =
    ...
    pub fn find_one<E>(&self, position: A1CellId) -> Result<Option<Entity<E>>>
    where
        E: EntityEssentials,
    {
        todo!()
    ...
    pub fn update<E>(&self, entity: &Entity<E>) -> Result<()>
    where
        E: EntityEssentials,
    {
        todo!()
    ...
    pub fn insert<E>(&self, entity_data: &E) -> Result<Entity<E>>
    where
        E: EntityEssentials,
    {
        todo!()
    ...
    pub fn delete<E>(&self, entity: &Entity<E>) -> Result<()>
    where
        E: EntityEssentials,
    {
